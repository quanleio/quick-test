...
function liteLeafCreator() {
  ...
  let stemGeometry = new THREE.CylinderBufferGeometry(0.2, 0.6, 32, 10);
  let stemMesh = new THREE.Mesh(stemGeometry);

  let leafTotalGeometry = new THREE.BufferGeometry()
  // leafTotalGeometry.merge(stemMesh.geometry, stemMesh.matrix);
  // leafTotalGeometry.merge(leaf);
  leafTotalGeometry = THREE.BufferGeometryUtils.mergeBufferGeometries([stemMesh.geometry, leaf]);
...
function createFlowers() {
  ...
  let stemGeometry = new THREE.CylinderBufferGeometry(0.3, 0.6, 8, 10);
